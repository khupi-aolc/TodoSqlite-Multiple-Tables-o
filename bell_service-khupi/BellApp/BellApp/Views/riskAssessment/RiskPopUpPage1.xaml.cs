...
{
    public partial class RiskPopUpPage1 : PopupPage
    {
        public RiskPopUpPage1(string headerpop)
        {
            InitializeComponent();
            BindingContext = new RiskPopup_1ViewModel(Navigation, headerpop);
            HeadingPopUp.Text = headerpop +"-PROBABILITY";
